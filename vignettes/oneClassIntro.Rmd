...
The function trainOcc() is a wrapper for carets (http://caret.r-forge.r-project.org/, [2]) train() function which is called with one of the one-class classification methods implemented in oneClass (see Section4). 
